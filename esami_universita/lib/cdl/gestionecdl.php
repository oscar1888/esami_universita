...
<html>
    ...
    ?>
<!--INIZIO-->
            <h3 class="uk-card-title">Gestione corsi di laurea</h3>
<!-------------------------------------------------------------------------------------------------------->
<div uk-grid>
    <div class="uk-width-1-3">
        <div class="uk-card uk-card-secondary uk-card-body uk-padding-small uk-text-left">
            <nav>
                ...
                $active_option = '';
                if (isset($_GET['mod']) && $_GET['mod'] == 'attiva') {
                        $active_option = 'class="uk-active"';
                }
                ?>
                <li <?php echo $active_option; ?>><a href="<?php echo $_SERVER['PHP_SELF'];?>?mod=attiva"> Attivazione</a></li>
                </ul>
            </nav>
        </div>
    </div>
        ...
        <div class="uk-card uk-card-default uk-card-body uk-padding-small uk-text-left">
         <?php
            if (isset($_GET) && isset($_GET['mod'])) {
                switch ($_GET['mod']) {
                case 'attiva':
                    include_once('attivacdl.php');   
                    break;
                case 'modifica':
                    include_once('modificacdl.php');   
                    break;
                case 'elimina':
                    include_once('eliminacdl.php');   
                    break;
                case 'crea':
                default:
                    include_once('creacdl.php'); 
                    break;
                }
            } else {
                include_once('creacdl.php');     
