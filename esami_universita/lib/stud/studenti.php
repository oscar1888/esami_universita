...
<html>
    ...
    ?>
<!--INIZIO-->
            <h3 class="uk-card-title">Gestione studenti</h3>
<!-------------------------------------------------------------------------------------------------------->
<div uk-grid>
    <div class="uk-width-1-5">
        <div class="uk-card uk-card-secondary uk-card-body uk-padding-small uk-text-left">
            <nav>
                ...
                $menu = get_menu_entries_gest('stud');
                ...
                $active_option = '';
                if (isset($_GET['mod']) && $_GET['mod'] == 'visual1') {
                        $active_option = 'class="uk-active"';
                }
                ?>
                <li <?php echo $active_option; ?>><a href="<?php echo $_SERVER['PHP_SELF'];?>?mod=visual1"> Studenti correnti</a></li>
                <?php
                $active_option = '';
                if (isset($_GET['mod']) && $_GET['mod'] == 'visual2') {
                        $active_option = 'class="uk-active"';
                }
                ?>
                <li <?php echo $active_option; ?>><a href="<?php echo $_SERVER['PHP_SELF'];?>?mod=visual2"> Storico studenti</a></li>
                </ul>
            </nav>
        </div>
    </div>
        ...
        <div class="uk-card uk-card-default uk-card-body uk-padding-small uk-text-left">
         <?php
            if (isset($_GET) && isset($_GET['mod'])) {
                switch ($_GET['mod']) {
                case 'visual1':
                    include_once('visualstudenticorr.php');   
                    break;
                case 'visual2':
                    include_once('visualstudentistor.php');   
                    break;
                case 'elimina':
                    include_once('eliminastudente.php');   
                    break;
                case 'crea':
                default:
                    include_once('creastudente.php'); 
                    break;
                }
            } else {
                include_once('creastudente.php');     
