...
<html>
    ...
    ?>
<!--INIZIO-->
            <h3 class="uk-card-title">Gestione calendario degli esami</h3>
<!-------------------------------------------------------------------------------------------------------->
<div uk-grid>
    <div class="uk-width-1-4">
        <div class="uk-card uk-card-secondary uk-card-body uk-padding-small uk-text-left">
            <nav>
                ...
                ?>
                <li <?php echo $active_option; ?>><a href="<?php echo $_SERVER['PHP_SELF'];?>?mod=visual"> Gestione</a></li>
                </ul>
            </nav>
        </div>
    </div>
        ...
        <div class="uk-card uk-card-default uk-card-body uk-padding-small uk-text-left">
         <?php
            if (isset($_GET) && isset($_GET['mod'])) {
                switch ($_GET['mod']) {
                case 'visual':
                    include_once('visuales.php');   
                    break;
                case 'modifica':
                    include_once('modificaes.php');   
                    break;
                case 'elimina':
                    include_once('eliminaes.php');   
                    break;
                case 'crea':
                default:
                    include_once('creaes.php'); 
                    break;
                }
            } else {
                include_once('creaes.php');     
